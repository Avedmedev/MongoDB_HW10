...
from database.repository import get_user_by_login, add_contact, update_contact, get_contacts, get_contact, \
    remove_contact
...
if __name__ == '__main__':
    ...
    if owner:
        ...
        if bcrypt.checkpw(password.encode('utf-8'), owner.hash.encode('utf-8')):
            main()
            print('Successful!')
        else:
